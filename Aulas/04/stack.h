...
bool s_push(Stack *stack, int valor) {
    ...
    if((size_t) (stack->stack_pointer + 2) > stack->allocated) {
        ...
        stack->stack = (int *) realloc(stack->stack, 
            sizeof(int) * stack->allocated);
...
int s_push(Stack *stack, int valor) {
